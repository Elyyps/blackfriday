...
var readdir = promisify_1.default(fs.readdir);
...
var fileExists = function (pathToWrite) {
    return access(pathToWrite).then(function () { return true; }, function () { return false; });
};
...
var prettyAdd = function (data, cfg, plop, prettierOpts) { return __awaiter(_this, void 0, void 0, function () {
