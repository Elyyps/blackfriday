...
const BASE_PATH = getConfig().API_URL.replace(/\/+$/, "");
/**
 *
 * @export
 */
...
export interface SocialMediaButtons {
  ...
  /**
   *
   * @type {Array&lt;ButtonFooter&gt;}
   * @memberof SocialMediaButtons
   */
  footerButtons: Array<ButtonFooter>;
}
...
export interface TabsModule {
  ...
  /**
   *
   * @type {Array&lt;TabsHeader&gt;}
   * @memberof TabsModule
   */
  tabsTitle: Array<TabsHeader>;
  /**
   *
   * @type {SalePointModule}
   * @memberof TabsModule
