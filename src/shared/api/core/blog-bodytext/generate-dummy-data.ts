  ...
  bodyText: {
    html: `<h2>
      ...
      <p>
        ...
        je niet alleen op 23 november 2018 <a href="#">Black Friday Nederland</a> goed in de gaten houdt, maar ook
      ...
      <p>
        ...
        tot Black Friday want we verwachten dat providers als <a href="#">Vodafone</a>, <a href="#">T-Mobile</a>
        , <a href="#">BEN</a> en <a href="#">Tele2</a> weer groots uit gaan pakken met de smartphone deals van
...
export const generateBlackFriday2019Text = (): BlogBodyTextModule => ({
  bodyText: {
    html: `<p><em>Profiteren van korting tijdens <strong>Black Friday 2019?!</strong> Hier lees je alles over de achtergronden van deze Amerikaanse traditie én hoe je er dit jaar zelf van profiteert.</em></p>
<p><strong><a href="#">Black Friday</a> is een Amerikaanse feestdag die altijd wordt gevierd op de dag na <a href="#">Thanksgiving</a>. De naam is ontstaan vanwege het feit dat het altijd heel erg druk was in de stad op de dag na Thanksgiving want iedereen was vrij. De dag na Thanksgiving was dus dé perfecte dag om koopjes te scoren en met scherpe deals voor de dag te komen. Nederland heeft deze traditie overgenomen en daardoor is het op de vierde vrijdag in november altijd gekkenhuis in de winkelstraten.</strong></p>
