...
export const generateProductLineDummyData = () =>
  `<div>
    ...
    <p>
      De belangrijkste reden dat Apple elektronische producten zoals de iPhone, en iPad zo enorm populair zijn, is omdat
      ze elk jaar nieuwere modellen introduceren en deze nieuwe modellen komen steeds met betere functies en
      ...
      Black Friday en blijven de hele dag open om zodoende de klanten zoveel mogelijk aan hun trekken te laten komen. Er
      is vaak al heel vroeg, een menigte klanten aanwezig en hierdoor ontstaan er soms onaangename scènes en situaties.
    </p>
    <p>
      Black Friday staat symbool voor fantastische koopjes en een ongelooflijke stijging in de verkoop, afhankelijk van
      welke kant je het bekijkt. Voor liefhebbers van de vele Apple producten, heeft deze dag een extra betekenis, omdat
      het ieder jaar weer hebben van het allernieuwste op het gebied van elektronisch apparatuur, ze een speciaal gevoel
      geeft. Black Friday 2019 komt er weer aan en tegen die tijd staan alle mooie en scherpe deals op deze pagina
      gepresenteerd!
    </p>
