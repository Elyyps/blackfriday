...
import { generateDummyFullBodyTextModule, generateProductLineDummyData } from "../modules/body-text/generate-dummy-data";
...
import { generateBodytextDummyData } from "../core/bodytext";
