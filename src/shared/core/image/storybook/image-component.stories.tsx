...
import IconDefault from "@assets/icons/clock.svg";
import IconDefault2 from "@assets/icons/store.svg";
...
storiesOf("Image Component", module)
  ...
  .add("Image should render fine", () => (
    <div className={styles["image-holder"]}>
      <ImageComponent src={Oasis} errorImage={IconDefault} />
    </div>
  ))
  ...
  .add("Image should render with given placeholder and text", () => (
    <div className={styles["image-holder"]}>
      <ImageComponent errorImage={IconDefault2} errorMessage="Custom error message" />
    </div>
  ));
