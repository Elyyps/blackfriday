  ...
  return (
    <div>
      <div className="deals-overview__tab" ref={topDivRef}>
        <TabComponent
          tabs={[
            { href: "/stores-overview", isSelected: true, title: props.intl.formatMessage({ id: "tab-winkels" }) },
            { href: "/deals-overview", title: props.intl.formatMessage({ id: "tab-productdeals" }) }
          ]}
        />
      </div>
