...
const CardProduct = (props: ICardProductProps) => {
  const { image, sub_title, title, sale, price, old_price, button_text, button_link, variant, label } = props;

  return (
    <div className={classNames("card-product", `card-product--${variant || "default"}`)}>
      {label ? (
