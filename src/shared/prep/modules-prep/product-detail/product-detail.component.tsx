...
const ProductDetailComponent = ({ image,labelList, cards,rating }: IProductDetailComponentComponentProps) => (
            ...
            <div className="product-detail__content">
              ...
              <div className="content">
                ...
                <div className="content__body">
                  Vier Black Friday bij Beddenreus en ontvang 15% korting op alles!
                  Black Friday bij Beddenreus wil je niet missen! Je geniet van maar liefst 15% korting op alles.
                  Extra interessant: Black Friday duurt bij Beddenreus niet één dag maar ruim een week. Dé week om
                  eens goed na te denken over een nieuwe boxspring, matras of dekbedovertrek! Want 15% korting dat is
                  héél veel! Hét ideale moment dus om jouw favoriete boxspring, matras of winterdekbed te kopen.
                  Online én in de winkel. Meer info
                </div>
                  <h3>De voordelen van shoppen bij Beddenreus tijdens Black Friday.</h3>
                ...
                <div className="actions">
                  ...
                  <div className="actions__item">
                    <div className="actions__item-wrap">
                      ...
                      <Button href={"#"} title={"secondary"} variant={"dropdown"}/>
                    </div>
                  </div>
                </div>
