...
import { BodyBlogData, HeaderData, FeaturedDeals, CTASimple, BlogFeaturedFields } from "./dummy-data";
  ...
  <div className={styles["blog-single"]}>
    ...
    <BodyBlogComponent {...BodyBlogData}>
      ...
      <p>
        ...
        je niet alleen op 23 november 2018 <Link to="#">Black Friday Nederland</Link> goed in de gaten houdt, maar ook
        in de week voor de kortingsdag van het jaar de website al iedere dag even checkt. Je weet nooit wanneer de deals
      ...
      <p>
        ...
        deals online komen dan vorig jaar. Ben je dus op zoek naar een <Link to="#">mobiel</Link>? Wacht dan nog even
        tot Black Friday want we verwachten dat providers als <Link to="#">Vodafone</Link>, <Link to="#">T-Mobile</Link>
        , <Link to="#">BEN</Link> en <Link to="#">Tele2</Link> weer groots uit gaan pakken met de smartphone deals van
        2018. De Samsung Galaxy of de Apple Iphone zijn smartphones waar je altijd wel een fikse korting op kunt vinden.
        Kun je niet wachten? Bekijk dan alvast de <Link to="#">Samsung Galaxy deals</Link> van dit moment.
      </p>
      ...
      <p>
        ...
        <Link to="#">Bol.com</Link> is het ook slim om dit jaar de kleine lokale winkels goed in de gaten te houden.
        Naar verwachting zullen de kleine winkels en boetiekjes in jouw dorp of stad ook meedoen aan Black Friday. Black
        Friday Nederland richt zich echter alleen op de landelijke bekende winkels, dus de aanbiedingen van dat kleine
      ...
      <p>
        ...
        onder andere merken als: <Link to="#">Ryanair</Link>, Hotels.com, <Link to="#">Expedia</Link> en Hilton. De
        verwachting is vooral dat er kortingen komen op vliegtickets en hotels met Black Friday 2018. Houd onze
        reispagina goed in de gaten voor een recent overzicht van alle <Link to="#">reisaanbiedingen</Link> met Black
        Friday.
      </p>
    </BodyBlogComponent>
